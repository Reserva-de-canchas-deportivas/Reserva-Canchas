    ...
    def _generar_slots(
        ...
        for reserva in reservas:
            ...
            rangos_ocupados.append({
                ...
                'fin': fin_con_buffer,
                'motivo': 'Reservado' if inicio_mins <= inicio_mins < fin_mins else 'Buffer'
            })
