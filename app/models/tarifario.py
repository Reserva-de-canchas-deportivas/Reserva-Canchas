...
class Tarifario(Base):
    ...
    hora_inicio = Column(
        String(5),
        nullable=False,
        comment="Hora de inicio de la franja (HH:MM)"
    )
    
    hora_fin = Column(
        String(5),
        nullable=False,
        comment="Hora de fin de la franja (HH:MM)"
    )
    
    precio_por_bloque = Column(
        Numeric(10, 2),
        nullable=False,
        comment="Precio por bloque de tiempo"
    )
    ...
    __table_args__ = (
        ...
        Index('idx_tarifario_sede_dia_hora', 'sede_id', 'dia_semana', 'hora_inicio', 'hora_fin'),
        Index('idx_tarifario_cancha_dia_hora', 'cancha_id', 'dia_semana', 'hora_inicio', 'hora_fin'),
    )
