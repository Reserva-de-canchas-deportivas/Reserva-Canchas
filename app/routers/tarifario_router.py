...
router = APIRouter(
    ...
    responses={
        404: {
            "model": ErrorResponse,
            "description": "Tarifa, Sede o Cancha no encontrada",
        },
...
def crear_tarifa(
    ...
    **Validaciones:**
    ...
    """
    logger.info("POST /tarifario - Crear tarifa")
...
def listar_tarifas(
    ...
    dia_semana: Optional[int] = Query(
        None, ge=0, le=6, description="Filtrar por día (0-6)"
    ),
    ...
    return ApiResponse(
        ...
        data=TarifarioListResponse(total=total, tarifas=tarifas_response),
        success=True,
    )
...
def consultar_tarifa_aplicable(
    ...
    """
    logger.info("GET /tarifario/consultar/aplicable")
